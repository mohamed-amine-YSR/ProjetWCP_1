...
export const routes = [
    {path: '', redirectTo: 'app', pathMatch: 'full'},
    {
        ...
        children: [
            ...
            { path: 'membres', loadChildren: './profiles/profiles.module#ProfilesModule' },
            ...
            { path: 'nouveau_projet', loadChildren: './newprojet/newprojet.module#NewprojetModule', canActivate: [AuthGuardService] },
